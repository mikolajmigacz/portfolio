...
export const portfolioData: PortfolioData = {
  ...
  profile: {
    ...
    shortBio: 'Dedicated Software Engineer with a passion for software development, continuously improving skills beyond professional commitments.',
    ...
    socials: {
      ...
      cv: 'https://drive.google.com/file/d/1h-FO1-X1Le6O8qWabI3peS4raGaCt96w/view?usp=drive_link',
  ...
  skills: [
    {
      category: 'Advanced',
      items: [
        'React', 'Node.js', 'TypeScript', 'JavaScript', 'AWS', 'Azure',
        'PostgreSQL', 'MongoDB', 'REST', 'gRPC', 'Jest', 'Cypress', 
        'Ant Design', 'Material-UI', 'HTML/CSS'
      ]
    },
    {
      category: 'Intermediate',
      items: [
        'Java', 'Spring', 'Go', '.NET', 'ASP.NET', 'Angular', 
        'Dart', 'Flutter', 'Tailwind', 'Firebase'
      ]
    },
    {
      category: 'Beginner',
